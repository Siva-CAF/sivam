package com.softclouds.kapture.kloader.ESConfig;
...
import com.softclouds.kapture.kloader.util.KloaderConstants;
	...
	public static Properties getProperties() throws IOException {
		if (properties == null) {
			...
			properties.load(RestHighLevelClientUtil.class.getClassLoader()
					.getResourceAsStream(KloaderConstants.ELASTIC_SEARCH_PROPERTIES));
		}
		return properties;
	}
